...
|----|---------|--------------------|------------------|----------------|-------------------|-------------------|-----------------|------------------|----------------------|--------|
| PROTO-4-001 | Traceability file created with all V2-4 IDs before code changes | File committed; git history shows before production commits | docs/integration-v2-4/REQUIREMENTS-TRACEABILITY.md @5b88f84 | git log shows before 7e08067 | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | IN_PROGRESS |
| PROTO-4-002 | Completion verifier scripts/verify-v2-4-completion.cjs fails if any row not PASS | Exit 1 on FAIL/UNVERIFIED; Cloud Sync must be PASS (no MISSING exception) | scripts/verify-v2-4-completion.cjs | node scripts/verify-v2-4-completion.cjs exits 1 until PASS | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | IN_PROGRESS |
| PROTO-4-003 | PR Release Gate workflow v2-4-release-gate.yml enforces tests/build/real-cloud/verify | GHA run URL; merge blocked on failure | .github/workflows/v2-4-release-gate.yml | workflow present | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | IN_PROGRESS |
| PROTO-4-004 | Windows cloud test workflow v2-4-cloud-test.yml | GHA run URL + artifacts | .github/workflows/v2-4-cloud-test.yml | workflow present | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | IN_PROGRESS |
| PROTO-4-005 | Real-cloud UAT workflow v2-4-real-cloud-uat.yml with protected env | GHA run URL; secrets never logged | .github/workflows/v2-4-real-cloud-uat.yml | workflow present; secrets blocked | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | IN_PROGRESS |
...
| ARCH-001 | Document current cloud reality from actual code (not stale docs) | 00-CURRENT-CLOUD-REALITY.md matches cloud/* + electron/* | docs/integration-v2-4/00-CURRENT-CLOUD-REALITY.md | manual code inspection | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | IN_PROGRESS |
| ARCH-002 | Document target architecture Local SQLite → Outbox → Sync → Drive → peers | 01-TARGET-ARCHITECTURE.md | docs/integration-v2-4/01-TARGET-ARCHITECTURE.md | doc | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | IN_PROGRESS |
| ARCH-003 | Module wiring matrix: REAL/WIRED/LOCAL/MOCK/DEAD/MISSING with imported/initialized/called/persisted | 02-MODULE-WIRING-MATRIX.md | docs/integration-v2-4/02-MODULE-WIRING-MATRIX.md | doc | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | IN_PROGRESS |
...
| OUTBOX-001 | Durable Outbox table in SQLite (not in-memory / not localStorage-only) | 06-OUTBOX-INBOX-DESIGN.md + schema | database/sync-outbox.js; migrations/002 | test-v2-4-outbox-dual-device.js | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | IN_PROGRESS |
...
| SYNC-001 | Cloud Sync end-to-end REAL (not Backup, not manual snapshot) | Cloud Sync=PASS in gate | cloud/sync-engine.js; drive-adapter; peer-sync-engine | FileRemote only — NOT real Drive multi-device | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED | NOT_STARTED |
